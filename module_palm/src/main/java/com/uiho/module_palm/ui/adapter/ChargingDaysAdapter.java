...
public class ChargingDaysAdapter extends BaseQuickAdapter<CarTripDaysModel.InfoArrayBean, BaseViewHolder> {
    public ChargingDaysAdapter(@Nullable List<CarTripDaysModel.InfoArrayBean> data) {
