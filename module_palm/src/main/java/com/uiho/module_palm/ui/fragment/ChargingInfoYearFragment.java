...
import com.uiho.module_palm.ui.adapter.ChargingMonthAdapter;
...
@Route(path = RouterPath.PALM_CHARGE_INFO_YEAR) // 路由地址，必须注明
public class ChargingInfoYearFragment extends BaseMvpFragment<TravelInfoClassifyContract.View, TravelInfoClassifyPresenter> implements TravelInfoClassifyContract.View {
    ...
    protected void initView(LayoutInflater inflater) {
        ...
        adapter = new ChargingMonthAdapter(mList);
...
//        });
    ...
    public static ChargingInfoYearFragment getInstance(String vin) {
        ChargingInfoYearFragment fragment = new ChargingInfoYearFragment();
