...
public class TravelMonthClassifyAdapter extends BaseQuickAdapter<CarTripDaysModel.InfoArrayBean, BaseViewHolder> {
    public TravelMonthClassifyAdapter(@Nullable List<CarTripDaysModel.InfoArrayBean> data) {
