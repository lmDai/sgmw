...
@Route(path = RouterPath.PALM_CHARGE_INFO_MONTH) // 路由地址，必须注明
public class ChargingInfoMonthFragment extends BaseMvpFragment<TravelInfoClassifyContract.View, TravelInfoClassifyPresenter> implements TravelInfoClassifyContract.View {
...
//        });
    ...
    public static ChargingInfoMonthFragment getInstance(String vin) {
        ChargingInfoMonthFragment fragment = new ChargingInfoMonthFragment();
