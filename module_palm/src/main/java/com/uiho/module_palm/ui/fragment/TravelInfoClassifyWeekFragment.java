...
@Route(path = RouterPath.PALM_TRAVEL_INFO_WEEK) // 路由地址，必须注明
public class TravelInfoClassifyWeekFragment extends BaseMvpFragment<TravelInfoClassifyContract.View, TravelInfoClassifyPresenter> implements TravelInfoClassifyContract.View {
...
//        });
    ...
    public static TravelInfoClassifyWeekFragment getInstance(String vin) {
        TravelInfoClassifyWeekFragment fragment = new TravelInfoClassifyWeekFragment();
